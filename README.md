...
[![Generic badge](https://img.shields.io/badge/npm%20package-v2.0.0-3FB911.svg)](https://www.npmjs.com/package/yk-color-picker)
...
```css
@import url("../node_modules/yk-color-picker/dist/esm2020-2.0.0/style.css");
```
